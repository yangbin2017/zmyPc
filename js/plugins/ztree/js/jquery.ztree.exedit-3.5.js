...
(function($){
		...
		onMousedownNode: function(eventMouseDown, _node) {
			...
			function _docMouseMove(event) {
				...
				if (root.dragFlag == 0) {
					...
					curNode = $$("<ul class='zTreeDragUL' style=''></ul>", setting);
	...
	_view = {
		...
		editNode: function(setting, node) {
			...
			view.cancelCurEditNode(setting);
			view.selectNode(setting, node, false);
			$$(node, consts.id.SPAN, setting).html("<input type=text class='rename' style='' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " >");
